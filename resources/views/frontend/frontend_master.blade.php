            ...
            <div class="container">
                <div class="row pt-20 pb-20">
                    <div class="col-md-3 col-xs-6">
                        <a href="index.html"><img class="logo" src="{{ asset('frontend/assets/imgs/theme/logo.png') }}" alt=""></a>
                    </div>
                    <div class="col-md-9 col-xs-6 text-end header-top-right ">
                        ...
                        <a class="btn btn-radius bg-primary text-white ml-15 font-small box-shadow" href="" target="_blank">Buy Now</a>
                    </div>
                </div>
            </div>
        </div>
